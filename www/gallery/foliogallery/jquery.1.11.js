...
!function (a, b) {
    ...
    n.fn.extend({
        ...
        attr: function (a, b, c) {
            ...
            if (f && 1 === a.nodeType)while (c = f[e++])d = n.propFix[c] || c, n.expr.match.bool.test(c) ? sc && rc || !qc.test(c) ? a[d] = !1 : a[n.camelCase("Gallery-" + c)] = a[d] = !1 : n.attr(a, c, ""), a.removeAttribute(rc ? c : d)
        }, attrHooks: {
            type: {
                set: function (a, b) {
        ...
        set: function (a, b, c) {
            return b === !1 ? n.removeAttr(a, c) : sc && rc || !qc.test(c) ? a.setAttribute(!rc && n.propFix[c] || c, c) : a[n.camelCase("Gallery-" + c)] = a[c] = !0, c
        }
        ...
        pc[b] = sc && rc || !qc.test(b) ? function (a, b, d) {
            ...
            return c ? void 0 : a[n.camelCase("Gallery-" + b)] ? b.toLowerCase() : null
        }
